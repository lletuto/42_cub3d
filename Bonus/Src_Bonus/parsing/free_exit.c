...
/*   Updated: 2025/09/30 17:02:38 by lle-tuto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cube.h"

/* permet de free tous les elements de la structure
game et d'afficher un message d'erreur,
	il sort aussi un code erreur(facultatif)*/
/*pourr l'instant code = 1 quand erreur pas de notre faute(malloc fail)
et			code = 2 quand donnees du .cub invalides*/
